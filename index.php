...
<body>
	...
	<nav class="sticky">
		<div class="row">
			<a href="#"><img src="/resources/img/logo-white.png" alt="Omnifood White Logo" class="logo"></a>
			<a href="#"><img src="/resources/img/logo.png" alt="Omnifood Black Logo" class="logo-black"></a>
		...
		<div class="hero-text-box js--scroll-to-plans">
  ...
  <section id="features" class="section-features js--section-features">
   ...
   <!-- The reason .row is not used here due to wanting the content to take up 100% of the page -->
   <!-- The figure element typically contains an image and a capture for an image. -->
   <!-- The child element of 'ul' is the 'li' which has the float property. The '.clearfix' property in styles.css has a ':after' which clears the float after the 'ul' element -->
   ...
   <section class="section-testimonals">
   	<div class="row">
   			...
   			<div class="col span-1-of-3">
   				<div class="plan-box">
   					<div>
   						...
   						<!-- The &nbsp; provides a blank space. This is necessary to make the $19 / meal match the other options -->
   ...
   <!-- The 'for' attribute in the 'label' element connects with the 'id' attribute. It makes it so when the user clicks on the label element it will place the user in the input field -->
   <div class="map-box">
   ...
   <footer>
	...
	<!-- Enables the browser to understand/execute CSS media queries -->
  <script src="vendors/js/respond.min.js"></script>
  
  <!-- Enables you to use and style HTML5 elements in older browsers -->
  <script src="vendors/js/html5shiv.min.js"></script>
  
  <!-- Enables you to use CSS pseudo classes on Internet Explorer 6, 7, and 8 -->
